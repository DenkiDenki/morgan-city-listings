...
function updateMarkers(){
  ...
  mapMarkersV2 = applyFilters(homesWithLatAndLong).map( function( homecity ){
    let marker = {
      ...
      image: homecity.custom_fields.gallery.length && homecity.custom_fields.gallery[0].sizes && homecity.custom_fields.gallery[0].sizes.list_img_crop ? homecity.custom_fields.gallery[0].sizes.list_img_crop : '/wp-content/uploads/2020/06/no-image.jpg',
      ...
      relatedFloorplans: homecity.floorplans.map(f => f.tiny_image ? f : Object.assign(f, {tiny_image: '/wp-content/uploads/2020/06/no-image.jpg'})),
